...
class AboutS2 extends Component{
    render(){
        return(    
            <Container fluid className="about-s2 d-flex minh-50vh align-items-center py-5 border-top border-secondary pt-5">
            <Row className="mx-0 w-100 mt-5">
                ...
                <Col xs={{span:12,order:2}} md={{span:5,order:1}} className="minh-50vh d-flex align-items-center">
                    <div className="w-100 text-center text-md-start text-shadow pe-md-5">
